...
module.exports = Router()
  .post('/', async(req, res, next) => {
    ...
    const moveLeft = req.body.event.text.split(' ')[1] === 'left';
    const moveRight = req.body.event.text.split(' ')[1] === 'right';
    ...
    if(!isBot && moveBack) {
      ...
      try {
        ...
        setTimeout(() => player.setControlState('back', false), 247);
        res.sendStatus(200);
      }
    ...
    if(!isBot && moveLeft) {
      ...
      try {
        ...
        setTimeout(() => player.setControlState('left', false), 247);
        res.sendStatus(200);
      }
    ...
    if(!isBot && moveRight) {
      ...
      try {
        ...
        setTimeout(() => player.setControlState('right', false), 247);
        res.sendStatus(200);
      }
